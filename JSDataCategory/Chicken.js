...
async function loadData() {
    try {
        const response1 = await fetch('../JSDataCategory/RevenueChicken.json');
        if (!response1.ok) throw new Error('Failed to load RevenueChicken.json');
        ...
        const response2 = await fetch('../JSDataCategory/QuantityChicken.json');
        if (!response2.ok) throw new Error('Failed to load QuantityChicken.json');
